...
- `tile` names come from the registry in `src/core/tiles.ts`. Outdoor: grass, grass2, meadow, flowers, path, water, tall_grass, tree, pine, bush, sign, rock, well, brazier, fence, cave_wall, brick. Buildings: roof_red_top/roof_red_eave (small houses), roof_slate_top/roof_slate_mid/roof_slate_eave (big halls), wall, wall_stone, window, door. Interior: floor_wood, floor_stone, rug, mat, iwall, iwall_top, counter, shelf, table, bed, plant, brazier_in.
